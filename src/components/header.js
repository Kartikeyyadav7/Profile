	...
	return (
		<header className={headerStyles.header}>
			...
			<div className={headerStyles.burger} onClick={handleClick}>
				<div className={toggle ? (headerStyles.toggle, headerStyles.toggleLine1) : headerStyles.line1} />
				<div className={toggle ? (headerStyles.toggle, headerStyles.toggleLine2) : headerStyles.line2} />
				<div className={toggle ? (headerStyles.toggle, headerStyles.toggleLine3) : headerStyles.line3} />
			</div>
		</header>
	);
};
